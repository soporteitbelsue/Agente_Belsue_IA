...
function PortalIcon({ scope }: { scope: AgentScope }) {
  if (scope === "seguros") {
    return (
      <span className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white ring-2 ring-belsue/20">
        <Image
          src={formadorImg}
          alt=""
  ...
  return (
    <span className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-belsue/10 text-belsue">
